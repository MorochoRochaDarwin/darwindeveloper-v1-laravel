...
@section('content')
    ...
    <div class="container-fluid">
        <form action="" id="form_new_post" enctype="multipart/form-data">
            ...
            <h2 style="text-align: center">Nuevo Libro - {{$categoria}}</h2>
            ...
            <input id="categoria" name="categoria" type="text" hidden value="{{$categoria}}">
            ...
            <div class="col-xs-12 text-right" style="padding: 0;">
                ...
                <a href="{{url('/admin/libros/'.urlencode($categoria))}}" style="font-size: 20px;" class="btn btn-default">Volver a
                    libros</a>
        ...
        $(function () {
            ...
            $('#form_new_post').submit(function () {
                ...
                if (img64 != null) {
                    ...
                    $.ajax({
                        url: '{{url('/admin/libros/'.$categoria.'/nuevo-libro')}}',
                        type: 'post',
                        data: fd,
                        processData: false,
                        contentType: false,
